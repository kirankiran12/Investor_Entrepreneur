...
import 'package:investorentrepreneur/Investor/investorditpersonaldetail.dart';


class InvestorPersonaldetal extends StatefulWidget {
  const InvestorPersonaldetal({super.key});

  @override
  State<InvestorPersonaldetal> createState() => _InvestorPersonaldetalState();
}

class _InvestorPersonaldetalState extends State<InvestorPersonaldetal> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const  EditInvestorPersonaldetal() ),
                      );
                    },
                    child: Text(
                      "Edit Detail",
            ...
            TextSpan(
              ...
              Divider(),
              SizedBox(height: 10),
              _buildDetailRow("Market Potential", "financial metrics", screenWidth),
                SizedBox(height: 10),
              Divider(),
                SizedBox(height: 5),
              _buildDetailRow("Involvement", "Moderatly involved", screenWidth),
                SizedBox(height: 10),
              Divider(),
                SizedBox(height: 10),
              _buildDetailRow("Investment Horizon", "Short time (1_2year)", screenWidth),
               SizedBox(height: 10),
               
              Divider(),
                SizedBox(height: 10),
              _buildDetailRow("Investment Success kips", "5 years", screenWidth),
               SizedBox(height: 20),
