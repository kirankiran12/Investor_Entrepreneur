...
class JobdoneScreen extends StatefulWidget {
  const JobdoneScreen({super.key});

  @override
  State<JobdoneScreen> createState() => _JobdoneScreenState();
}

class _JobdoneScreenState extends State<JobdoneScreen> {
  @override
